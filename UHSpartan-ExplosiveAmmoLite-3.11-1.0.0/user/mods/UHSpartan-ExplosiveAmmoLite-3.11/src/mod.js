...
/**
 * UHSpartan Explosive Ammo Lite (SPT 3.11)
 * One EX per caliber (choose a representative round with a valid prefab/icon).
 * Adds locale entries so names/descriptions render correctly.
 */

class ExplosiveAmmoMod {
    constructor() {
        this.mod = "UHSpartan-ExplosiveAmmoLite";
        this.logger = null;
    }
    ...
    postDBLoad(container) {
        ...
        // Naming controls
        const NAME_PREFIX = "UH-EXL";           // shown in Name/ShortName
